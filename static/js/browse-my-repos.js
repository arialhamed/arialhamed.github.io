...
async function browseRun(inUrl, rootRepoUrl="") {
  ...
  document.getElementById("current-url-display").innerHTML = "<span id=\"cud-inner\" style=\"cursor: pointer;\" onclick=copyCurrentUrl() title=\"Copy current API URL\">" + inUrl.slice(22) + "</span>";
