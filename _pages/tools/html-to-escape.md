...
<script>function arrayToTable(a){var n=$("<table></table>");return $(a).each(function(a,e){var t=$("<tr></tr>");$(e).each(function(a,e){t.append($("<td><kbd>"+e+"</kbd></td>"))}),n.append(t)}),n}function refreshOutput(){var a=gId("input_raw").value;console.log(a)}$.ajax({type:"GET",url:"https://cdn.calibri-turtle.pages.dev/others/htmlescape.csv",success:function(a){$("#escape-table").append(arrayToTable(Papa.parse(a).data))}});</script>
<script></script>
