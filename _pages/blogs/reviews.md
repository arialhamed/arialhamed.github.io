        ...
        {% for post in site.categories.reviews %}
            <a href="{{ site.baseurl }}{{ post.url }}">
                <div class="captioned-containerM">
                    <img src="https://cdn.calibri-turtle.pages.dev/images{{ post.url }}.jpeg" onerror="this.src='https://cdn.calibri-turtle.pages.dev/images/missing.jpeg'" style="width:100%;">
                    <div class="content">
...
<div class="row" id="reviews-days">
    ...
    <div class="col-sm-4" title="{{ post.title }}" style="margin-bottom: 10px;">
        <div class="card" style="background-color:#333 !important;color:var(--font-color) !important;">
            <div class="card-body">
                <a href="{{site.baseurl}}{{post.url}}">
                    <img class="card-img" src="https://cdn.calibri-turtle.pages.dev/images{{ post.url }}.jpeg" onerror="this.src='https://cdn.calibri-turtle.pages.dev/images/missing.jpeg'" alt="{{ post.title }} icon" style="padding: 0 !important; margin: 0 !important;vertical-align: inherit !important; -webkit-box-shadow: none; box-shadow: none; border: none;">
