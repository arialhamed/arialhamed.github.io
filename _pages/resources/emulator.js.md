...
<div style="max-width:100%; max-height:100%;">
  <div id="game"></div>
  <div id="loading-gif" style="text-align:center;"><img src="https://cdn.calibri-turtle.pages.dev/images/spinner.gif"></div>
</div>
<br>
<div class="container">
...
EJS_gameUrl = "https://cdn.calibri-turtle.pages.dev/games/roms/" + romName.slice(-3) + "/" + romName;
if (["nds", "gba"].includes(romName.slice(-3))) {
  EJS_biosUrl = "https://cdn.calibri-turtle.pages.dev/others/" + romName.slice(-3) + ".zip";
}
EJS_defaultControls = {
  0: {
