...
<html>
    ...
    <body>
        ...
        <script>
            ...
            // r.svg => https://cdn.calibri-turtle.pages.dev/images/games/chess/bR.svg
            ...
            function updateBoard(){
                for (var i = 0; i < currentPos.length; i++){
                    document.getElementsByClassName("boardPiece")[i].setAttribute("src", "https://cdn.calibri-turtle.pages.dev/images/games/chess/"+currentPos[i].substr(0)+".svg");
                }
            }
            ...
            function clickedTile(tile_id){
                ...
                if (targetedTile.src != "https://cdn.calibri-turtle.pages.dev/images/games/chess/x.svg" && currentPiece == currentPiece.toUpperCase()){
            ...
            function toggleHighlightTile(tile_id){
                ...
                if (targetedTile.style.animation == "" && targetedTile.src != "https://cdn.calibri-turtle.pages.dev/images/games/chess/x.svg"){
