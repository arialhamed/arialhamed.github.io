---
title: "Concepts & probably some design"
subtitle: ""
...
- **Fabricants**
    ...
    - Characters:
        ...
        - **Lato** (story): The last sane Fabricant from Sleipnolt V who <span onclick="this.innerHTML = 'gives the crew a Matrix of Ascension after telling them the tale of Sir Tahoma. She then dies, which triggers the planet to self-destruct'"><em>&lt;spoilers&gt;</em></span>
...
- Opus Atrophia, aka Cult of Corruption
    ...
    - Ranks
        ...
        - Oracle
        - Scion of Corruption
    - <span onclick="this.innerHTML='It was originally ordered by a former Grand Starcaller in an attempt to destroy vices in all sentient creatures, a way of controlling over the races.'"><em>Spoilers</em></span>
- Opus Stupri (hostile)
...
- _Mortemneoxenoic Era_: When all races started to fight each other in conflicts (Atrophus appears towards the end of the )
