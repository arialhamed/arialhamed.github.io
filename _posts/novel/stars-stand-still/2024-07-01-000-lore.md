...
<table class="table container wide-responsive" style="background-color:#0003;color:#ddd;font-size:1em">
    <thead>
        <tr>
            <th>Name (Age)</th>
            <th>Race & Class</th>
    ...
    <tbody>
        <tr>
            <th>Calibri (21yo)</th>
            <th>Fabricant Knight</th>
            <th>Calm on the outside, always ruminating in the inside, usually positive but also analytical, sensitive to sound. Loves to eat human food due to her upbringing, though Fabricant food gives her better nutrients.</th>
            ...
            <th><ul><li>Design: Optimus Prime from Transformers</li><li>Backstory: Naija from Aquaria</li><li>Weapon: Gyomei Himejima from Demon Slayer</li><li>Music: Avalanche by BMTH</li></ul></th>
            <th>Always feeling out of place, imposter syndrome ➔ Resolved by <span onclick="this.innerHTML='coming to terms with finding out she was actually a human in a Fabricant\'s body, and her adoptive parents are actually her biological parents. Initially when she finds details about her parents on Sleipnot V, she goes into a deep depression and becomes missing from the crew on the planet, and there\'s like a whole chapter about this. She meets the spirit of Tahoma and more dialogue. She attains Tahoma\'s true form of power along with Tahoma\'s Matrix of Ascension.'">████</span></th>
        </tr>
        <tr>
            <th>Kristeria (21yo)</th>
            <th>D'meteri Artificer</th>
            <th>Mischievous, hates fire</th>
            <th>Poison ➔ Flame</th>
            <th>Cannon</th>
            <th><ul><li>Same school as Calibri</li></ul></th>
            <th><ul><li>Body design: </li><li>Armor design: Alchemist from Torchlight I</li><li>Music: Gasoline by I Prevail</li></ul></th>
            <th>Strained relationship with family ➔ Resolved by <span onclick="this.innerHTML='burning her home planet that was corrupted after reconciling with her father, the last surviving D\'meteri in '">████</span></th>
        </tr>
        <tr>
            <th>Salkynei (221yo)</th>
            <th>Ko'scoria Barbarian</th>
            <th>Resilient, soft-spoken</th>
            <th>Flame ➔ Frost</th>
            <th>2 Claymores, 2 Axes</th>
            <th><ul><li>Born from Sirius A's expiration</li><li>Curious about water</li></ul></th>
            <th><ul><li></li></ul></th>
            <th>Anger management issues</th>
        </tr>
        <tr>
            <th>Zorinnethinas (30yo)</th>
            ...
            <th>Lost his partner few years ago</th>
        </tr>
        <tr>
            <th>Varsha (3725yo)</th>
            <th>Human Vampire</th>
