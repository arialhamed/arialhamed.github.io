...
<style>table * * *{font-weight:normal}</style>
...
<table class="table container wide-responsive" style="background-color:#0003;color:#ddd;font-size:1em;display:block;overflow-x:auto;white-space:nowrap;border:1px solid white;">
    ...
    <tbody>
        <tr>
            ...
            <th>Sir Tahoma 7X<ul><li>Monarch of The First Liberated Fabricant Order</li><li>Known as the first Fabricant to unlock their programming, and awakened the Fabricants <br>from the confines of The Sandbox Cluster with the powers from the Aether, effectively <br>converting all Fabricants to be true sentient, living beings.</li><li>Destroyed the remaining Iron Ancients as a warning to other races who dares take over <br>the Fabricants.</li><li>About a millenia after their death, they save Calibri's soul from being consumed by <br>Atrophus and sealed her into her eyes, then fit those eyes into an alloy body inspired <br>by his design, then hid her to the door of an orphanage.</li></ul></th>
        ...
        <tr>
            ...
            <th>Alspruce<ul><li>A D'meteri Assassin known in writing for defending Plantera from undead D'meteri by <br>sacrificing himself with an infernal explosion that destroyed Plantera after sending a <br>fragment out into space to regrow</li><li>Later revealed that the truth was that Plantera was actually a star parasite, and it was <br>going to eat their star, and the fragment was one that Alspruce missed.</li><li>Alspruce appears before Kristeria to give her the Flame MoA to destroy Plantera.</li></ul></th>
            ...
            <th>"Gasoline" by I Prevail - The fight (hell yeah). <br>She uses internalized anger and her exploding <br>pods during the fight.</th>
        </tr>
        <tr>
            ...
            <th>A bright lava interior, covered by a thin & strong layer <br>of a transparent membrane, holding all the lava <br>together to form a humanoid shape. The sclera is <br>solid rock. Usually in sleeveless tungsten chainmail.</th>
        ...
        <tr>
            ...
            <th>Cards</th>
            <th><ul><li></li><li></li></ul></th>
            <th>Hunter<ul><li>Zorin's wife, secretly works for the Flowmasons, a shadow organization of <br>the Lophiizards. Also the youngest Ascended Guide.</li><li>She disagreed with their plan to terraform a planet with life for more Lophiizard habitats, <br>so she destroyed their terraforming ship by stealing its' Power Core and hid. </li><li>It was not long when she met Zorin on a distant planet, got married and attempted to <br>have a child, unfortunately ending in a miscarriage.</li><li>One day, she appeared to have committed suicide, right next to Zorin on their bed</li><li>As a spirit, she appears to Zorin when the crew is at the shipwreck of the Flowmasons' <br>terraformer, where she tells him the truth: the miscarriage was the actually <br>caused by the Flowmasons (the suicide was real though)</li><li>After a short while, Zorin enters that state of blank-faced rage to kill the leader of the <br>Flowmasons, who was there to attempt to revive the ship with the same Power Core.</li><li>So after he absolutely wrecks that piece of shit, Hunter appears before him again and <br>unlocks the power core which was actually the Electric MoA. She moves on to the <br>Flowing Deep after apologizing to Zorin for leaving him behind.</li><li>Name is inspired from The Owl House's Hunter, NOT Hunter Schafer</li></ul></th>
            <th><ul><li>Backstory: The man from "To The Flowers" by While She Sleeps</li><li>Design: Lucien Lachance from TES 4: Oblivion & Undyne from Undertale</li><li>Weapon: Luz from The Owl House</li></ul></th>
        ...
        <tr>
            ...
            <th>Celeste<ul><li>Was a </li><li></li></ul></th>
