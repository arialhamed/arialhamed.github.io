...
> _"Welcome to UNDERTALE. In this RPG, you control a human who falls underground into the world of monsters. Now you must find your way out... or stay trapped forever." - <a href="https://store.steampowered.com/app/391540/Undertale/">Steam</a>_

<timestamp>21 April 2022:</timestamp> Now imagine my surprise to find a mobile version of this game that exists.

While scavenging for APKs in a certain website, i came across Undertale. After finding out that perhaps people actually thought of porting the game from PC to Android (unofficially), i did a quick google search and found <a href="https://www.moddb.com/mods/undertale-mobile-mod">this</a>. All the details should be in the ModDB site, but just in case anyway, i've copied the guide here too.
...
Posted by <a href="https://www.moddb.com/members/jockeholm">Jockeholm</a> on Nov 27th, 2019 - Intermediate Other
...
1. Download the <a href="https://raw.githubusercontent.com/arialhamed/static/main/archives/Undertale_Mobile_Mod_2.0.0.zip">mod zip</a> (last updated as of <timestamp>09-Dec-2019</timestamp>).
...
1. Download <a href="http://www.cydiaimpactor.com/">Cydia Impactor</a>
1. Create or login to your <a href="https://appleid.apple.com/account/manage">AppleID</a> and generate an app specific password. (You may need to enable 2FA to do this.)
...
1. Install ReProvision (<a href="https://repo.incendo.ws/">repo link</a>) & Filza File Manager via Cydia
